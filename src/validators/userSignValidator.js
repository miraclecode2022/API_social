const userSignValidator = (req,res,next) => {
    // Check Name
    req.check('name', 'Name cannot be empty!!').notEmpty() // Check empty
    req.check('name', 'Name must be between 4 and 100 characters').isLength({
        min : 4,
        max : 100
    })
